...
Revision ID: 59d600e2438
Revises: None
Create Date: 2016-09-16 23:47:09.064000

"""

# revision identifiers, used by Alembic.
revision = '59d600e2438'
down_revision = None
...
def upgrade():
    ...
    sa.Column('new_avatar_file', sa.String(length=64), nullable=True),
    ...
    sa.Column('timestamp', sa.DateTime(), nullable=True),
    sa.Column('status', sa.Enum('read', 'unread', 'delete', name='status'), nullable=True),
    sa.Column('types', sa.Enum('private', 'public', 'all', name='types'), nullable=True),
