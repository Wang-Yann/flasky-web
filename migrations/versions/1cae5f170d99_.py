...
Revision ID: 1cae5f170d99
Revises: None
Create Date: 2016-07-14 10:35:43.652173

"""

# revision identifiers, used by Alembic.
revision = '1cae5f170d99'
down_revision = None
...
def upgrade():
    ...
    op.create_index('ix_userlikepost_post_id', 'userlikepost', ['post_id'], unique=False)
    op.create_index('ix_userlikepost_user_id', 'userlikepost', ['user_id'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ix_userlikepost_user_id', 'userlikepost')
    op.drop_index('ix_userlikepost_post_id', 'userlikepost')
